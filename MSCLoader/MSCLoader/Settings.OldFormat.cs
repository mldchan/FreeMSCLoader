...
public partial class Settings
{
    ...
    public static SettingsCheckBox AddCheckBox(Mod mod, string settingID, string name, bool value = false,
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static SettingsCheckBoxGroup AddCheckBoxGroup(Mod mod, string settingID, string name, bool value = false,
        string group = null, Action onValueChanged = null)
    {
        settingsMod = mod; //Just for backward compatibility (if settings were made outside ModSettings function)
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static SettingsSliderInt AddSlider(Mod mod, string settingID, string name, int minValue, int maxValue,
        int value = 0, Action onValueChanged = null, string[] textValues = null)
    {
        settingsMod = mod; //Just for backward compatibility (if settings were made outside ModSettings function)
    ...
    /// <returns></returns>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static SettingsSlider AddSlider(Mod mod, string settingID, string name, float minValue, float maxValue,
        float value = 0f, Action onValueChanged = null, int decimalPoints = 2)
    {
        settingsMod = mod; //Just for backward compatibility (if settings were made outside ModSettings function)
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static SettingsTextBox AddTextBox(Mod mod, string settingID, string name, string value,
        string placeholderText)
    {
        return AddTextBox(mod, settingID, name, value, placeholderText, InputField.ContentType.Standard);
    }
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static SettingsDropDownList AddDropDownList(Mod mod, string settingID, string name, string[] arrayOfItems,
        int defaultSelected = 0, Action OnSelectionChanged = null)
    {
        settingsMod = mod; //Just for backward compatibility (if settings were made outside ModSettings function)
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static SettingsColorPicker AddColorPickerRGB(Mod mod, string settingID, string name,
        Action OnColorChanged = null)
    {
        return AddColorPickerRGBInternal(mod, settingID, name, new Color32(0, 0, 0, 255), OnColorChanged, false);
    }
    ...
    /// <returns>SettingsColorPicker</returns>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static SettingsColorPicker AddColorPickerRGBA(Mod mod, string settingID, string name,
        Action OnColorChanged = null)
    {
        return AddColorPickerRGBInternal(mod, settingID, name, new Color32(0, 0, 0, 255), OnColorChanged, true);
    }
    ...
    /// <returns>SettingsColorPicker</returns>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static SettingsColorPicker AddColorPickerRGB(Mod mod, string settingID, string name, Color32 defaultColor,
        Action OnColorChanged = null)
    {
        return AddColorPickerRGBInternal(mod, settingID, name, defaultColor, OnColorChanged, false);
    }
    ...
    /// <returns>SettingsColorPicker</returns>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static SettingsColorPicker AddColorPickerRGBA(Mod mod, string settingID, string name, Color32 defaultColor,
        Action OnColorChanged = null)
    {
        return AddColorPickerRGBInternal(mod, settingID, name, defaultColor, OnColorChanged, true);
    }

    [EditorBrowsable(EditorBrowsableState.Never)]
    internal static SettingsColorPicker AddColorPickerRGBInternal(Mod mod, string settingID, string name,
        Color32 defaultColor, Action OnColorChanged, bool showAlphaSlider)
    {
        settingsMod = mod; //Just for backward compatibility (if settings were made outside ModSettings function)
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static void AddButton(Mod mod, string name, Action onClick)
    {
        AddButton(mod, $"{mod.ID}_btn", name, onClick, new Color32(85, 38, 0, 255), Color.white);
    }
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static void AddButton(Mod mod, string name, Action onClick, Color btnColor, Color buttonTextColor)
    {
        AddButton(mod, $"{mod.ID}_btn", name, onClick, btnColor, buttonTextColor);
    }
    ...
    /// <param name="onClick">What to do when button is clicked</param>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static void AddButton(Mod mod, string settingID, string name, Action onClick)
    {
        AddButton(mod, settingID, name, onClick, new Color32(85, 38, 0, 255), Color.white);
    }
    ...
    /// <param name="buttonTextColor">Button text color</param>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static void AddButton(Mod mod, string settingID, string name, Action onClick, Color btnColor,
    ...
    public static void AddResetButton(Mod mod, string name, Settings[] sets)
    {
        ...
        for (var i = 0; i < sets.Length; i++) list.Add(sets[i].modSetting);
    ...
    {
        AddHeader(mod, HeaderTitle, false);
    }
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static void AddHeader(Mod mod, string HeaderTitle, bool collapsedByDefault = false)
    {
        AddHeader(mod, HeaderTitle, new Color32(95, 34, 18, 255), new Color32(236, 229, 2, 255), collapsedByDefault);
    }
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static void AddHeader(Mod mod, string HeaderTitle, Color backgroundColor)
    {
        AddHeader(mod, HeaderTitle, backgroundColor, false);
    }
    ...
    /// <param name="collapsedByDefault">Header collapsed by default (optional default=false)</param>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static void AddHeader(Mod mod, string HeaderTitle, Color backgroundColor, bool collapsedByDefault = false)
    {
        AddHeader(mod, HeaderTitle, backgroundColor, new Color32(236, 229, 2, 255), collapsedByDefault);
    }
    ...
    {
        AddHeader(mod, HeaderTitle, backgroundColor, textColor, false);
    }
    ...
    /// <summary>
    ///     Add dynamic Header, same as AddHeader but returns value, you can collapse/expand/change color of it from other
    ///     settings.
    /// </summary>
    /// <param name="mod">Your mod instance</param>
    /// <param name="HeaderTitle">Title of your header</param>
    ...
    {
        settingsMod = mod; //Just for backward compatibility (if settings were made outside ModSettings function)
        var s = new SettingsDynamicHeader(HeaderTitle, new Color32(95, 34, 18, 255), new Color32(236, 229, 2, 255),
            collapsedByDefault);
    ...
    {
        settingsMod = mod; //Just for backward compatibility (if settings were made outside ModSettings function)
        var s = new SettingsDynamicText(text);
        settingsMod.modSettingsList.Add(s);
        return s;
    }
}
