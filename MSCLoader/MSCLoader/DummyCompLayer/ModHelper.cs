...
public static class ModHelper
{
    ...
    public static void PlaySound3D(this Transform transform, string type, string variation, float volume = 1f,
        float pitch = 1f)
    {
        MSCLoaderHelpers.ModHelper.PlaySound3D(transform, type, variation, volume, pitch);
    }
    ...
    public static void PlaySound3D(this Vector3 vector3, string type, string variation, float volume = 1f,
        float pitch = 1f)
    {
        MSCLoaderHelpers.ModHelper.PlaySound3D(vector3, type, variation, volume, pitch);
    }
    ...
    {
        MSCLoaderHelpers.ModHelper.SetParent(transform, parent, position, rotation, scale, name);
    }
...
public static class PlayMakerHelper
{
    ...
    public static bool GUIAssemble
    {
        ...
        set => FSMGUIAssemble.Value = value;
    }
    ...
    public static bool GUIDisassemble
    {
        ...
        set => FSMGUIDisassemble.Value = value;
    }
    ...
    public static bool GUIPassenger
    {
        ...
        set => FSMGUIPassenger.Value = value;
    }
    ...
    public static string GUIInteraction
    {
        ...
        set => FSMGUIInteraction.Value = value;
    }
    ...
    public static string GUISubtitle
    {
        ...
        set => FSMGUISubtitle.Value = value;
    }

    [Obsolete("DON'T USE THIS WILL MESS UP REFERENCE")]
    public static void Setup()
    {
        typeof(MSCLoaderHelpers.PlayMakerHelper).GetProperty("FSMGUIUse", BindingFlags.Public | BindingFlags.Static)
            .SetValue("nothing", FsmVariables.GlobalVariables.FindFsmBool("GUIuse"), null);
        typeof(MSCLoaderHelpers.PlayMakerHelper)
            .GetProperty("FSMGUIAssemble", BindingFlags.Public | BindingFlags.Static).SetValue("nothing",
                FsmVariables.GlobalVariables.FindFsmBool("GUIassemble"), null);
        typeof(MSCLoaderHelpers.PlayMakerHelper)
            .GetProperty("FSMGUIDisassemble", BindingFlags.Public | BindingFlags.Static).SetValue("nothing",
                FsmVariables.GlobalVariables.FindFsmBool("GUIdisassemble"), null);
        typeof(MSCLoaderHelpers.PlayMakerHelper).GetProperty("FSMGUIBuy", BindingFlags.Public | BindingFlags.Static)
            .SetValue("nothing", FsmVariables.GlobalVariables.FindFsmBool("GUIbuy"), null);
        typeof(MSCLoaderHelpers.PlayMakerHelper).GetProperty("FSMGUIDrive", BindingFlags.Public | BindingFlags.Static)
            .SetValue("nothing", FsmVariables.GlobalVariables.FindFsmBool("GUIdrive"), null);
        typeof(MSCLoaderHelpers.PlayMakerHelper)
            .GetProperty("FSMGUIPassenger", BindingFlags.Public | BindingFlags.Static).SetValue("nothing",
                FsmVariables.GlobalVariables.FindFsmBool("GUIpassenger"), null);
        typeof(MSCLoaderHelpers.PlayMakerHelper)
            .GetProperty("FSMGUIInteraction", BindingFlags.Public | BindingFlags.Static).SetValue("nothing",
                FsmVariables.GlobalVariables.FindFsmString("GUIinteraction"), null);
        typeof(MSCLoaderHelpers.PlayMakerHelper)
            .GetProperty("FSMGUISubtitle", BindingFlags.Public | BindingFlags.Static).SetValue("nothing",
                FsmVariables.GlobalVariables.FindFsmString("GUIsubtitle"), null);
...
public static class PlayMakerProxyHelper
{
    ...
    public static void Add(this PlayMakerHashTableProxy proxy, IEnumerable<string> keys, IEnumerable<object> items,
        bool clear = false)
    {
        MSCLoaderHelpers.PlayMakerProxyHelper.Add(proxy, keys, items, clear);
    }
    ...
    {
        MSCLoaderHelpers.PlayMakerProxyHelper.AddPrefill(proxy, keys, items, clear);
    }
