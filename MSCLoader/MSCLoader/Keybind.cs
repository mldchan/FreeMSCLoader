...
public class Keybind
{
    ...
    {
        var keyb = new Keybind(id, name, key, modifier) { Mod = mod };
    ...
    {
        AddHeader(mod, HeaderTitle, Color.blue, Color.white);
    }
    ...
    {
        AddHeader(mod, HeaderTitle, backgroundColor, Color.white);
    }
    ...
    {
        var kb = new Keybind(null, HeaderTitle, KeyCode.None, KeyCode.None)
        {
            Mod = mod,
    ...
    {
        if (Modifier != KeyCode.None) return Input.GetKey(Modifier) && Input.GetKey(Key);
    ...
    {
        if (Modifier != KeyCode.None) return Input.GetKey(Modifier) && Input.GetKeyDown(Key);
    ...
    {
        if (Modifier != KeyCode.None) return Input.GetKey(Modifier) && Input.GetKeyUp(Key);
